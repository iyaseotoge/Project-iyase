...
config.data = --[[data]] {
	...
	OverallDifficulty = 5,
	autosave = false,
	covers = {bottom = {enabled = false,  position = 240,  size = 48}, top = {enabled = false,  position = 241,  size = 48}},
	mania = {ComboPosition = 96, HitPosition = 456, ScorePosition = 166, SplitStages = 0, UpsideDown = 0}
} --[[/data]]
