...
config.data = --[[data]] {
	...
	OverallDifficulty = 5,
	autosave = false,
	covers = {bottom = {enabled = false,  position = 240,  size = 48}, top = {enabled = false,  position = 240,  size = 48}},
	mania = {ComboPosition = 111, HitPosition = 402, ScorePosition = 325, SplitStages = 1, UpsideDown = 0}
} --[[/data]]
